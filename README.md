...
|------|-------------|----------|---------|--------|--------|------|
| AiDataGenByLeo | Build AI-powered trading systems with automatic feature generation, DSL-based configuration, and 85+ built-in features. | MQL5, Python, FGBLC, CSS, JS, HTML | [NL-ND]  | ✅ Active | 🌐 Public | Lib | 
