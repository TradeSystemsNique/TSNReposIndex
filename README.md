...
|------|-------------|----------|---------|--------|--------|------|
| AiDataGenByLeo | Build AI-powered trading systems with automatic feature generation, DSL-based configuration, and 85+ built-in features. | MQL5, Python, FGBLC, CSS, JS, HTML, JSON | [NL-ND]  | ✅ Active | 🌐 Public | Lib | 
